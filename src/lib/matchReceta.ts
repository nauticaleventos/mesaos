...
const LOCAL_SUBS: Record<string, string[]> = {
  ...
  'mantequilla':           ['mantequilla sin sal','aceite de coco','aceite de oliva','margarina vegetal'],
  'mantequilla sin sal':   ['mantequilla','margarina vegetal','aceite de coco'],
  ...
  'azucar':                ['panela','miel','stevia','azucar de coco','azucar morena','azucar moreno','azucar rubia','azucar blanca'],
  'azucar blanca':         ['azucar','azucar morena','azucar moreno','panela'],
  ...
  'aceite vegetal':        ['aceite de girasol','aceite de canola','aceite de oliva','aceite de coco'],
  'aceite de girasol':     ['aceite vegetal','aceite de canola','aceite de oliva'],
  'aceite de canola':      ['aceite vegetal','aceite de girasol','aceite de oliva'],
  'aceite de oliva':       ['aceite de oliva extra virgen','aceite vegetal','aceite de girasol','aceite de coco'],
  'aceite de oliva extra virgen': ['aceite de oliva','aceite vegetal'],
  'vinagre':               ['jugo de limón','vinagre de manzana','vinagre balsámico'],
  'limón':                 ['naranja','maracuyá','vinagre de manzana'],
  'huevo':                 ['huevo completo','huevos enteros','huevo de codorniz'],
  'huevo completo':        ['huevo','huevos enteros'],
  'huevos enteros':        ['huevo','huevo completo'],
  // Ajo — NO incluye "ajo porro" (= puerro, ingrediente distinto)
  'ajo':                   ['ajo en polvo','ajo picado','ajo machacado','ajo por la mitad'],
  'ajo en polvo':          ['ajo','ajo picado','ajo machacado'],
  'ajo picado':            ['ajo','ajo machacado','ajo en polvo'],
  'ajo machacado':         ['ajo','ajo picado','ajo en polvo'],
  'ajo por la mitad':      ['ajo','ajo picado','ajo machacado'],
  // Miel
  'miel':                  ['miel clara','miel de abeja','panela','azucar'],
  'miel clara':            ['miel','miel de abeja'],
  'miel de abeja':         ['miel','miel clara'],
  // Mostazas
  'mostaza':               ['mostaza dijon','mostaza amarilla','mostaza a la antigua'],
  'mostaza dijon':         ['mostaza','mostaza amarilla','mostaza a la antigua'],
  'mostaza amarilla':      ['mostaza','mostaza dijon','mostaza a la antigua'],
  'mostaza a la antigua':  ['mostaza','mostaza dijon','mostaza amarilla'],
  // Pimientas
  'pimienta':              ['pimienta negra','pimienta blanca'],
  'pimienta negra':        ['pimienta','pimienta blanca'],
  'pimienta blanca':       ['pimienta','pimienta negra'],
  // Sales
  'sal':                   ['sal marina','sal del himalaya'],
  'sal marina':            ['sal','sal del himalaya'],
  'sal del himalaya':      ['sal','sal marina'],
  // Proteína en polvo — sabores/tipos intercambiables (misma categoría: suplementos)
  'whey protein':                ['whey protein vainilla','proteina en polvo chocolate','proteina vegetal','proteina en polvo'],
  'whey protein vainilla':       ['whey protein','proteina en polvo chocolate','proteina vegetal','proteina en polvo'],
  'proteina en polvo':           ['whey protein','whey protein vainilla','proteina en polvo chocolate','proteina vegetal'],
  'proteina en polvo chocolate': ['whey protein','whey protein vainilla','proteina vegetal','proteina en polvo'],
  'proteina vegetal':            ['whey protein','proteina en polvo chocolate','proteina en polvo'],
}
